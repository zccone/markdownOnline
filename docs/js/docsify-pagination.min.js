!function (n, e) {
  ...
  "use strict";
  var n, a = (function (n, e) {
    function t(n, e) {
      return e.querySelector(n)
    }

    (e = n.exports = function (n, e) {
      return t(n, e = e || document)
    }).all = function (n, e) {
      return (e = e || document).querySelectorAll(n)
    }, e.engine = function (n) {
      if (!n.one) throw new Error(".one callback required");
      if (!n.all) throw new Error(".all callback required");
      return t = n.one, e.all = n.all, e
    }
  ...
  var e = Element.prototype,
    ...
    l = function (n, e) {
      ...
      for (var t = o.all(e, n.parentNode), i = 0; i < t.length; ++i) if (t[i] == n) return !0;
      return !1
    };
  try {
    var i = l
  ...
  var t = function () {
    ...
    return n
  }, p = {previousText: "PREVIOUS", nextText: "NEXT"}, u = "docsify-pagination-container";
  ...
  function g(e, n) {
    return 1 === arguments.length ? function (n) {
      return g(e, n)
    } : decodeURIComponent(n.getAttribute("href").split("?")[0]) === decodeURIComponent("#" + e)
  }
  ...
  var m = function () {
    function e(n) {
      ...
      }(this, e), n && (this.hyperlink = d(n))
    }

    return t(e, [{
      key: "toJSON", value: function () {
        if (this.hyperlink) return {name: this.hyperlink.innerText, href: this.hyperlink.getAttribute("href")}
      }
    }]), e
  }();
  var h = function () {
  ...
  window.$docsify = window.$docsify || {}, window.$docsify.plugins = [function (n, e) {
    var t = s({}, p, e.config.pagination || {});

    function i() {
      var n = a("." + u);
      n && (n.innerHTML = v(function (n) {
        try {
          var t = n.route.path, e = f(a.all(".sidebar li a")).filter(function (n) {
            return !l(n, ".section-link")
          }).find(g(t)), i = f((c(e, "ul") || {}).children).filter(function (n) {
            return "LI" === n.tagName.toUpperCase()
          }), o = i.findIndex(function (n) {
            var e = d(n);
            return e && g(t, e)
          });
          return {prev: new m(i[o - 1]).toJSON(), next: new m(i[o + 1]).toJSON()}
        } catch (n) {
          return {}
        }
      }(e), t))
